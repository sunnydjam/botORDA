...
- ♾️ **Безлимитный трафик** — без ограничений (на платном тарифе)
- 🔄 **Автоматическое создание proxy-аккаунта** — сразу после оплаты
- 🔔 **Уведомления админу** — о каждом платеже и новом trial
- ⏰ **Авто-проверка trial** — отключение по истечении времени или трафика

## 📋 Тарифы

| Тариф | Цена | Срок | Трафик |
|-------|------|------|--------|
| 🎁 Пробный | Бесплатно | 3 дня | 3 GB |
